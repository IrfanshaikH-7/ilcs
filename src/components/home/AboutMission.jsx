...
export default function AboutMission() {
  return (
    ...
    <div className="flex h-full md:h-40 bg-white rounded-md  py-6 md:py-6 md:px-6 border shadow-lg gap-2  items-center relative justify-center mx-auto ">
      ...
      <h1 className='text-center text-2xl font-bold bg-slate-300 px-6 py-2 rounded-md absolute -top-8 left-1/2 -translate-x-1/2'>About Us</h1>
...
<h1 className='text-center text-2xl font-bold bg-slate-300 px-6 py-2 rounded-md absolute -top-8 left-1/2 -translate-x-1/2 break-keep w-full max-w-[240px]'>Our Mission</h1>
<p className=" text-sm md:text-base text-center font-medium text-neutral-600 flex-[0.9]  ">
